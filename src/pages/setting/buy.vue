<template>
     <div v-loading="loading" class="bg-white p-4 rounded">
            ...
            <el-tabs v-model="activeName">
                ...
                <el-tab-pane  label="购物设置" name="second">
                    <el-form-item label="未支付订单">
                       ...
                       <small class="text text-gray-500 flex mt-1">订单下单未付款，n分钟后自动关闭，设置0不自动关闭</small>
                       </div>
                    </el-form-item>
                    <el-form-item label="已发货订单">
                       ...
                       <small class="text text-gray-500 flex mt-1">如果在期间未确认收货，系统自动完成收货，设置0不自动收货</small>
                       </div>
                    </el-form-item>
                    <el-form-item label="已完成订单">
                       ...
                       <small class="text text-gray-500 flex mt-1">订单完成后，用户在n天内可以发起售后申请，设置0不允许申请售后</small>
                       </div>
                    </el-form-item>
        ...
        <FormDrawer title="配置" @submit="submit" ref="formDrawerRef">
                ...
                <el-form-item label="cert_client">
                    <el-upload :action="uploadAction" :headers="{token}" accept=".pem" :limit="1" :on-success="uploadClientSuccess">
                        ...
                        <template #tip>
                            ...
                            <div class="el-upload_tip">例如:apiclient_cert.pem</div>
                        </template>
                    </el-upload>
                </el-form-item>
                <el-form-item label="cert_key">
                    <el-upload :action="uploadAction" :headers="{token}" accept=".pem" :limit="1" :on-success="uploadKeySuccess">
                        ...
                        <template #tip>
                            ...
                            <div class="el-upload_tip">例如:apiclient_key.pem</div>
                        </template>
                    </el-upload>
                </el-form-item>
            </el-form>
