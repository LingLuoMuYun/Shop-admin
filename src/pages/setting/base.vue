    ...
    <div v-loading="loading" class="bg-white p-4 rounded">
        <el-form :model="form" label-width="160px">
            <el-tabs v-model="activeName">
                <el-tab-pane  label="注册和访问" name="first">
                ...
                <el-tab-pane  label="上传设置" name="second">
                    ...
                    <el-form-item label="空间域名">
                       ...
                       <small class="text text-gray-500 flex mt-1">请补全 http:// 或 https:// </small>
                    </el-form-item>
                </el-tab-pane>
                ...
                <el-tab-pane  label="API安全" name="third">
                    <el-form-item label="是否开启API安全">
                        ...
                        <small class="text text-gray-500 flex mt-1">api安全功能开启之后调用前端api需要传输签名串</small>
                    </el-form-item>
                    <el-form-item label="密钥">
                       <el-input v-model="form.api_secret" placeholder="密钥" style="width: 30%;"></el-input>
                    </el-form-item>
                    <small class="text text-gray-500 flex mt-1">
